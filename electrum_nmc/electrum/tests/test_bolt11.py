...
class TestBolt11(ElectrumTestCase):
    ...
    def test_roundtrip(self):
        ...
        tests = [
            ...
            (LnAddr(date=timestamp, paymenthash=RHASH, currency=BitcoinTestnet.SEGWIT_HRP, tags=[('f', 'mk2QpYatsKicvFVuTAQLBryyccRXMUaGHP'), ('h', longdescription)]),
            ...
            (LnAddr(date=timestamp, paymenthash=RHASH, amount=24, tags=[
                ...
                ('f', frombtc('1RustyRX2oai4EYYDpQGWvEL62BBGqN9T')),
                ('h', longdescription)]),
            ...
            (LnAddr(date=timestamp, paymenthash=RHASH, amount=24, tags=[('f', frombtc('3EktnHQD7RiAE6uzMj2ZifT9YgRrkSgzQX')), ('h', longdescription)]),
            ...
            (LnAddr(date=timestamp, paymenthash=RHASH, amount=24, tags=[('f', frombtc('bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4')), ('h', longdescription)]),
            ...
            (LnAddr(date=timestamp, paymenthash=RHASH, amount=24, tags=[('f', frombtc('bc1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3qccfmv3')), ('h', longdescription)]),
