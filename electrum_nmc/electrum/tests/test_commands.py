...
class TestCommands(ElectrumTestCase):
    ...
    def test_export_private_key_imported(self, mock_save_db):
        ...
        with self.assertRaises(Exception):
            cmds._run('getprivatekeys', (frombtc("bc1qgfam82qk7uwh5j2xxmcd8cmklpe0zackyj6r23"),), wallet=wallet)  # not in wallet
        self.assertEqual(frombtc("p2wpkh:L4jkdiXszG26SUYvwwJhzGwg37H2nLhrbip7u6crmgNeJysv5FHL"),
                         cmds._run('getprivatekeys', (frombtc("bc1q2ccr34wzep58d4239tl3x3734ttle92a8srmuw"),), wallet=wallet))
        # list of addresses tests
        with self.assertRaises(Exception):
            cmds._run('getprivatekeys', ([frombtc('bc1q2ccr34wzep58d4239tl3x3734ttle92a8srmuw'), 'asd'], ), wallet=wallet)
    ...
    def test_export_private_key_deterministic(self, mock_save_db):
        ...
        self.assertEqual(frombtc("p2wpkh:L15oxP24NMNAXxq5r2aom24pHPtt3Fet8ZutgL155Bad93GSubM2"),
                         cmds._run('getprivatekeys', (frombtc("bc1q3g5tmkmlvxryhh843v4dz026avatc0zzr6h3af"),), wallet=wallet))
        # list of addresses tests
        with self.assertRaises(Exception):
            cmds._run('getprivatekeys', ([frombtc('bc1q3g5tmkmlvxryhh843v4dz026avatc0zzr6h3af'), 'asd'],), wallet=wallet)
        self.assertEqual([frombtc('p2wpkh:L15oxP24NMNAXxq5r2aom24pHPtt3Fet8ZutgL155Bad93GSubM2'), frombtc('p2wpkh:L4rYY5QpfN6wJEF4SEKDpcGhTPnCe9zcGs6hiSnhpprZqVywFifN')],
                         cmds._run('getprivatekeys', ([frombtc('bc1q3g5tmkmlvxryhh843v4dz026avatc0zzr6h3af'), frombtc('bc1q9pzjpjq4nqx5ycnywekcmycqz0wjp2nq604y2n')], ), wallet=wallet))
