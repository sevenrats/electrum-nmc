...
Builder.load_file('electrum_nmc/electrum/gui/kivy/uix/ui_screens/history.kv')
Builder.load_file('electrum_nmc/electrum/gui/kivy/uix/ui_screens/send.kv')
Builder.load_file('electrum_nmc/electrum/gui/kivy/uix/ui_screens/receive.kv')
...
class HistoryScreen(CScreen):
    ...
    def get_card(self, tx_item): #tx_hash, tx_mined_status, value, balance):
        ...
        if is_lightning:
            ...
            icon = "atlas://electrum_nmc/electrum/gui/kivy/theming/light/lightning"
